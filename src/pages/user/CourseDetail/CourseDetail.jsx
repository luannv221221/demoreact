              ...
              <div className="instructor-wrap border-bottom-0 m-0">
                <div className="about-instructor align-items-center">
                  <div className="abt-instructor-img">
                    <a href="">
                      <img
                        src={currentCourse?.teacherDto?.image}
                        alt="img"
                        className="img-fluid"
                      />
                    </a>
                  ...
                  <div className="instructor-detail me-3">
                    <h5>
                      <a href="">{currentCourse?.teacherDto?.name}</a>
                    </h5>
                    <p>Teacher</p>
                  </div>
                    ...
                    <div className="card-body">
                      <div className="video-details">
                        ...
                        <div
                          ...
                          className="btn btn-enroll w-100 bg-rikkei hover:bg-red-500 text-white hover:text-white transition-colors duration-300"
                        >
                          Học ngay
                        </div>
                      </div>
